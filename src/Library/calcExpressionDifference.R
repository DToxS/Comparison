...
calcExpressionDifference <- function(read_counts, exprt_design, drug_groups, subset_field_name=NULL, bio_spec, time_length, results_dir, ctrl_state_name="CTRL", fdrs=c(0.05), min_samples=3, min_samples_req="all", dispersion="auto", n_top=100, deg_only=TRUE, norm_base=1e+6, remove_small=TRUE, read_counts_title="ReadCounts", deg_title="DEG", top_title="TOP", exp_configs_title="ExpConfigs", calc_title="Calc", plot_title="Plots", deg_image_type="png", deg_image_width=NULL, deg_image_height=NULL, single_deg_image_file=FALSE, plot_bcv=TRUE, plot_smear=TRUE, pt_chars=c(16,19), verbose1=FALSE, verbose2=FALSE, func_dir=NULL)
{
