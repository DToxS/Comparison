...
recordGeneExpDiffs <- function(deg_read_counts, targets, state_names, read_counts, cell_line, plate, n_top, read_counts_file=NULL, exp_configs_file=NULL, top_stats_file=NULL, deg_stats_file=NULL, verbose=FALSE, func_dir=NULL)
{
